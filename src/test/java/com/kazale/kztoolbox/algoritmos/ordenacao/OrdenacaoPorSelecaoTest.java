...
/**
 * Testes da classe OrdenacaoPorSelecao, classe que implementa o algoritmo de
...
public class OrdenacaoPorSelecaoTest {
    ...
    private OrdenacaoPorSelecao ordenacaoPorSelecao = new OrdenacaoPorSelecao();

    @Test
    public void testOrdenarListaSimples() {
        int[] listaOrdenar = { 4, 1, 3, 9, 7 };
        int[] listaOrdenada = { 1, 3, 4, 7, 9 };
        ordenacaoPorSelecao.ordenar(listaOrdenar);
